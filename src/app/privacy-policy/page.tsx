...
const Element = ({
  ...
  return (
    <div className="pb-[3.75rem] flex flex-col gap-[0.81rem]">
      <div className="text-1.25-700 text-gray-6">{title}</div>
      <div className="text-1-500 text-gray-7">{children}</div>
    </div>
  );
};
...
export default function PrivacyPolicy() {
  return (
    <div className="flex justify-center items-center sm:p-[2rem] p-[6.88rem]ç">
      <div className="  flex flex-col items-start justify-center gap-[5rem]">
        <h1 className="text-3-700 sm:text-2-700">개인정보처리방침</h1>
